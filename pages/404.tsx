      ...
      <div className="px-4 mx-auto max-w-screen-xl md:px-8">
        <div className="grid gap-8 sm:grid-cols-2 sm:gap-12">
          ...
          <div className="flex flex-col justify-center items-center sm:items-start md:py-24 lg:py-32 xl:py-64">
            ...
            <Link href="/">
              <button className="inline-block py-3 px-8 text-sm font-semibold tracking-wider text-center text-white active:text-gray-700 bg-teal-500 hover:bg-teal-700 rounded-lg outline-none focus-visible:ring ring-teal-300 transition duration-100 md:text-base">
                {" "}
                ホームへ戻る
              </button>{" "}
            </Link>
