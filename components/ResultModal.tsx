          ...
          >
            <div className="inline-block overflow-hidden relative text-left align-bottom bg-white rounded-lg shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
              ...
              <div className="py-3 px-4 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-10">
                <Link href="/about">
                  <a className="inline-flex justify-center py-3 px-8 w-full text-sm font-semibold tracking-wider text-center text-white active:text-gray-700 bg-teal-500 hover:bg-teal-700 rounded-lg outline-none focus-visible:ring ring-teal-300 transition duration-100 md:text-base">
                    ホームへ戻る
                  </a>
                </Link>
              </div>
